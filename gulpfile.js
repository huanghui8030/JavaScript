...
var ArrAll = {
    lessDir : 'shoppingMenu/less',      //需要解析的less文件目录
    cssDir : 'shoppingMenu/css',       //需要解析的less文件目录
    cssRes : 'shoppingMenu/css', //生成的css目录
    cssMin : 'shoppingMenu/css' ,    //生成的min.css目录
    jsSrc : 'src/js',         //js目录
    ...
    gulp.src([ArrAll.lessDir+'/*.less','!'+ArrAll.lessDir+'/_*.less']) //该任务针对的文件和不对其进行处理的文件
        ...
        .pipe(autoprefixer({               //加厂商前缀
            browsers: ['Android 2.3','Android >= 4','iOS >= 6',
              'Explorer >= 6','Chrome >= 20','Firefox >= 12','Opera >= 12'],
